...
var dao = require("codbex-currencies/data/dao/Currencies/CurrencyEntity");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-currencies/api/CurrencyEntity.js/" + entity.Id);
