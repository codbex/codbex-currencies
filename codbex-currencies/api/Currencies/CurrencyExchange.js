...
var dao = require("codbex-currencies/data/dao/Currencies/CurrencyExchange");
var http = require("codbex-currencies/api/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-currencies/api/CurrencyExchange.js/" + entity.Id);
