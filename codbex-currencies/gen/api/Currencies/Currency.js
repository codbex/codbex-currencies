...
const dao = require("codbex-currencies/gen/dao/Currencies/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-currencies/gen/api/Currency.js/" + entity.Code);
