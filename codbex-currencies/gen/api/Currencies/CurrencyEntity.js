...
var dao = require("codbex-currencies/gen/dao/Currencies/CurrencyEntity");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("CurrencyEntity not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-currencies/gen/api/CurrencyEntity.js/" + entity.Id);
