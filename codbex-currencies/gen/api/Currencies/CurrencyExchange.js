...
var dao = require("codbex-currencies/gen/dao/Currencies/CurrencyExchange");
var http = require("codbex-currencies/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-currencies/gen/api/CurrencyExchange.js/" + entity.Id);
