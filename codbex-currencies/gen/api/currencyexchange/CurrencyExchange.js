...
const dao = require("codbex-currencies/gen/dao/currencyexchange/CurrencyExchange");
const http = require("codbex-currencies/gen/api/utils/http");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("CurrencyExchange not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-currencies/gen/api/CurrencyExchange.js/" + entity.Id);
