...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-portal.Currencies.CurrencyEntity.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-portal.Currencies.CurrencyEntity.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-currencies/gen/api/Currencies/CurrencyEntity.js';
	var currencycodeOptionsApi = '/services/v4/js/codbex-currencies/gen/api/Currencies/Currency.js';
